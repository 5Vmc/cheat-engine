...
begin
  ...
  c:=penv^.FindClass(penv, 'org/shengengine/TObject');
...
var jnimethods: array [0..methodcount-1] of JNINativeMethod =(
  (name: 'create'; signature: '(Lorg/shengengine/TMemScan;)J'; fnPtr: @TMemScan_Create),
...
begin
  ...
  c:=env^.FindClass(env, 'org/shengengine/TMemScan');
