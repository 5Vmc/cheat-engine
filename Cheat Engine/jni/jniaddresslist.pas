...
var jnimethods: array [0..methodcount-1] of JNINativeMethod =(
  ...
  (name: 'GetEntry'; signature: '(I)Lorg/shengengine/AddressListEntry;'; fnPtr: @addresslist_getEntry),
  (name: 'SetEntry'; signature: '(ILorg/shengengine/AddressListEntry;)V'; fnPtr: @addresslist_setEntry),
  (name: 'AddEntry'; signature: '(Lorg/shengengine/AddressListEntry;)I'; fnPtr: @addresslist_addEntry),
...
begin
  ...
  c:=env^.FindClass(env, 'org/shengengine/AddressList');
  env^.RegisterNatives(env, c, @jnimethods[0], methodcount);

  c:=env^.FindClass(env, 'org/shengengine/AddressListEntry');
