...
begin
  ...
  try
    ...
    begin
      ...
      if customfont then
      begin
        if Reg.OpenKey('\Software\'+strShengEngine+'\DissectData\Font'+darkmodestring,true) then
...
begin
  ...
  try
    ...
    begin
      ...
      if Reg.OpenKey('\Software\'+strShengEngine+'\DissectData\Font'+darkmodestring,false) then
      begin
