...
resourcestring
  rsFirstStepTooHardBetterGiveUpNow =
    'First step too hard? Go to forum.%63%68%65%61%74%65%6E%67%69%6E%65%2E%6F%72%67, then click on "Tutorials" for helpful guides!';

  rsTutorial1='Welcome to the Sheng Engine Tutorial (v3.6)'+#13#10+
              ''+#13#10+
              'This tutorial will teach you the basics of cheating in video games. It will also show you foundational aspects of using Sheng Engine (or CE for short). Follow the steps below to get started.'+#13#10+
              ''+#13#10+
              '1: Open Sheng Engine if it currently isn''t running.'+#13#10+
              ...
              ''+#13#10+
              'Congratulations! If you did everything correctly, the process window should be gone with Sheng Engine now attached to the tutorial (you will see the process name towards the top-center of CE).'+#13#10+
              ''+#13#10+
...
{  //search for sheng engine
  ...
  begin
    ...
    begin
      ...
      if (uppercase(processname)='CHEAT ENGINE SERVER.EXE') or (uppercase(processname)='CESERVER.EXE') or (uppercase(processname)='ShengEngine.EXE') or (uppercase(processname)='CHEAT ENGINE.EXE') then
      begin
