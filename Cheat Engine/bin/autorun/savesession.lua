...
function loadMemoryScan()
	...
	dialog.Filter=translate("Sheng Engine Scan files").." (*.CS)|*.CS"
...
s.LoadFromFile(getShengEngineDir()..[[autorun\images\export128x128.png]])
...
local s=createPicture()
s.LoadFromFile(getShengEngineDir()..[[autorun\images\import128x128.png]])
local ii=MainForm.mfImageList.add(s.Bitmap)
