...
#if defined TCC_TARGET_ARM64 || defined TCC_TARGET_RISCV64 || defined TCC_TARGET_ARM || defined TCC_TARGET_X86_64  //sheng engine : Added check for TCC_TARGET_X86_64
