...
resourcestring
  ...
  rsModuleLoaderDailedToMDbk64sysToMemoryap = 'ModuleLoader failed to map SGameEngine64.sys to memory';
...
begin
  ...
  try
   ...
   // ShowMessage('Part 1');
    ...
    ml:=TModuleLoader.create(ShengEngineDir+'SGameEngine64.sys');
