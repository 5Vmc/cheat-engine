...
resourcestring
  ...
  rsNoStartAddress = 'If you don''t include the header data you''ll have to specify the startaddress yourself when loading the file(That means '+strShengEngine+' won''t fill in the '
...
begin
  ...
  begin
    ...
    try
      ...
      begin
        f.WriteBuffer(pchar('ShengEngine')^,11);
        temp:=3; //version
