...
resourcestring
  ...
  rsYouAreMissingTheDriver = 'You are missing the driver. Try reinstalling '+strShengEngine+', and try to disable your anti-virus before doing so.';
  ...
  rsTheDriverThatIsCurrentlyLoaded = 'The driver that is currently loaded belongs to a different version of '+strShengEngine+'. Please unload this driver or reboot.';
  ...
  rsPleaseRunThe64BitVersionOfCE = 'Please run the 64-bit version of '+strShengEngine;
    ...
    //  usealternatedebugmethod:=false;
      ...
      try
        ...
        begin
          ...
          servicename:='Sheng Engine Service';
          ...
          if iswow64 then
          begin
            sysfile:='SGameEngine64.sys';
            ultimapsysfile:='ultimap2-64.sys';
          end
          else
          begin
            sysfile:='SGameEngine32.sys';
            ultimapsysfile:='';
          end;
