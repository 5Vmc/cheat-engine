...
resourcestring
  ...
  rsUUPleaseRunThe64bitVersionOfShengEngineToMakeUseOfThisFeature = 'Please run the 64-bit version of '+strShengEngine+' to make use of this feature';
...
begin
  ...
  {$ifdef cpu32}
  if Is64bitOS then raise exception.create(rsUUPleaseRunThe64bitVersionOfShengEngineToMakeUseOfThisFeature);
  {$endif}
