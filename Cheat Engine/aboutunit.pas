...
begin
  shellexecute(0,'open',pchar('https://www.00ue.com/53.html'),nil,nil,sw_maximize);
end;

procedure TAbout.Label8Click(Sender: TObject);
begin
  ShellExecute(0, pchar('open'),pchar('https://00ue.com/'), pchar(''),pchar(''), SW_MAXIMIZE	);
end;

procedure TAbout.Label9Click(Sender: TObject);
begin
  ShellExecute(0, pchar('open'),pchar('https://www.00ue.com/53.html'), pchar(''),pchar(''), SW_MAXIMIZE	);
end;
