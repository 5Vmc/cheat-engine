...
begin
  ...
  begin
    if @DebugActiveProcessStop=@DebugActiveProcessStopProstitute then
      mes:='This will attach the debugger of Sheng Engine to the current process. If you close Sheng Engine while the game is running, the game will close too. Are you sure you want to do this?'
    else
      mes:='This will attach the debugger of Sheng Engine to the current process. Continue?';
...
//        attaching:=false;
        ...
        err:='Sheng Engine failed to create the process. (Error='+pchar(IntToStr(GetLastError))+')';
        messagebox(0,pchar(err),'Create failure',mb_ok);
  ...
  //    }
      ...
      begin
        ...
        {$ifndef net}
        err:='Sheng Engine failed to attach to the process. (Error='+IntToStr(GetLastError)+')';
        ...
        case devent.dwDebugEventCode of
          ...
          begin
            ...
            begin
              ...
              begin
                //check if this is a exception breakpoint that was made by sheng engine
                      ...
                      try
                        ...
                        begin
                          ...
                          begin
                            ...
                            j:=devent.dwThreadId;
                            if not WaitForDebugEvent(devent,10000) then application.MessageBox('userbreakpoint bug','Sheng Engine Debugger',0);
