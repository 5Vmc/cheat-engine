...
begin
  synhighlighter.LoadFromRegistry(HKEY_CURRENT_USER, '\Software\'+strShengEngine+'\Lua Highlighter'+darkmodestring);
end;
...
begin
  ...
  begin
    synhighlighter.SaveToRegistry(HKEY_CURRENT_USER, '\Software\'+strShengEngine+'\Lua Highlighter'+darkmodestring);
