...
begin
  result:=loadFromRegistryDefault(HKEY_CURRENT_USER, '\Software\'+strShengEngine+'\CPP Highlighter'+darkmodestring);
end;
    ...
    case changeHighlighter of
      ...
      begin
        ...
        begin
          ...
          fLuaSyntaxHighlighter.LoadFromRegistry(HKEY_CURRENT_USER, '\Software\'+strShengEngine+'\Lua Highlighter'+darkmodestring);
        end;
      ...
      begin
        ...
        begin
          ...
          fFPCSyntaxHighlighter.LoadFromRegistry(HKEY_CURRENT_USER, '\Software\'+strShengEngine+'\Pascal Highlighter'+darkmodestring);
        end;
      ...
      begin
        ...
        begin
          ...
          fCPPSyntaxHighlighter.loadFromRegistryDefault(HKEY_CURRENT_USER, '\Software\'+strShengEngine+'\CPP Highlighter'+darkmodestring);
...
begin
  ...
  if fLuaSyntaxHighlighter<>nil then
    fLuaSyntaxHighlighter.LoadFromRegistry(HKEY_CURRENT_USER, '\Software\'+strShengEngine+'\Lua Highlighter'+darkmodestring);  //perhaps make this a var

  if fCPPSyntaxHighlighter<>nil then
    fCPPSyntaxHighlighter.loadFromRegistryDefault(HKEY_CURRENT_USER, '\Software\'+strShengEngine+'\CPP Highlighter'+darkmodestring);  //perhaps make this a var
